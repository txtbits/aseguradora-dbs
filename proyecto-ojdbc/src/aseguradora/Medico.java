 ...
 * @author Exode-P
 */
public class Medico extends javax.swing.JFrame implements Serializable {
    /**
    ...
    public Medico(ConnectOracle co){
        conection = co;
        initComponents();
        cargarMedico();
    }
    ...
    public void cargarMedico() {
            try {
                ...
                tablaMedico.setModel(DbUtils.resultSetToTableModel(rsst));
    ...
    private void buscarMedico(String nombre) {
            try {
                String sql = "select * from medico where upper(N_M) LIKE ?";
                PreparedStatement prst = conection.createStatement(sql);
    ...
    private void insertarMedico(){
            try {
                ...
                PreparedStatement prst = conection.createStatement(sql);
                prst.setInt(1, Integer.parseInt(etCodMedico.getText()));
                prst.setString(2, etNomMedico.getText());
                prst.setInt(3, Integer.parseInt(etCodHospital.getText()));
                prst.executeUpdate();
                conection.confirmar();
                cargarMedico();
            } catch (SQLException e) {
    ...
    private void actualizarMedico() {
            int row = tablaMedico.getSelectedRow();
            try {
                String sql = "update medico set COD_M = ?, N_M = ?, COD_H = ? WHERE COD_M = ?";
                PreparedStatement prst = conection.createStatement(sql);
                prst.setInt(1, Integer.parseInt(etCodMedico.getText()));
                prst.setString(2, etNomMedico.getText());
                prst.setInt(3, Integer.parseInt(etCodHospital.getText()));
                int cod_m = (row == -1) ? Integer.parseInt(etCodMedico.getText().toString()) : Integer.parseInt(tablaMedico.getModel().getValueAt(row, 0).toString());
                prst.setInt(4, cod_m);
                prst.executeUpdate();
                conection.confirmar();
                cargarMedico();
    ...
    private void eliminarMedico() {
        try {
                String sql = "delete from medico where COD_M = ?";
                PreparedStatement prst = conection.createStatement(sql);
                prst.setInt(1, Integer.parseInt(etCodMedico.getText()));
                prst.executeUpdate();
                conection.confirmar();
