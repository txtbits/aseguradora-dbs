...
public class HospitalVentana extends javax.swing.JFrame implements Serializable {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HospitalVentana.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void buscarHospital(String nombre) {
		...
		Query cons = session.createQuery( 
                "from pojo.Hospital as hos "
                + "where upper(hos.NH) LIKE ?");
    ...
    private void actualizarHospital() {
            ...
            try {
        		...
        		Transaction tx = session.beginTransaction();
            	Hospital hospital = new Hospital();
            	Short cod_h = (row == -1) ? Short.parseShort(etCodHospital.getText().toString()) : Short.parseShort(tablaHospital.getModel().getValueAt(row, 0).toString());
